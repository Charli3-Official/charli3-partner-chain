...
pub fn pc_create_chain_spec(config: &CreateChainSpecConfig<SessionKeys>) -> serde_json::Value {
	let runtime_genesis_config = partner_chains_runtime::RuntimeGenesisConfig {
		system: partner_chains_runtime::SystemConfig::default(),
		balances: partner_chains_runtime::BalancesConfig::default(),
		aura: partner_chains_runtime::AuraConfig::default(),
		grandpa: partner_chains_runtime::GrandpaConfig::default(),
		sudo: partner_chains_runtime::SudoConfig::default(),
		...
		test_helper_pallet: partner_chains_runtime::TestHelperPalletConfig {
